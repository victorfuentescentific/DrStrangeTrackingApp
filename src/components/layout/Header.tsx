...
// Display names for user roles shown in the header badge
        ...
        <div className="relative">
          ...
          >
            ...
            <div className="text-left hidden sm:block">
              ...
              <div className={cn('text-[10px] px-1 rounded font-medium', ROLE_COLORS[currentUser.role] ?? 'bg-slate-100 text-slate-600')}>
                ...
                {MOCK_USERS.map(user => (
                  ...
                  >
                    ...
                    <div className="text-left">
                      ...
                      <div className={cn('text-[10px]', ROLE_COLORS[user.role] ?? 'text-slate-500')}>{ROLE_DISPLAY[user.role] ?? user.role}</div>
                    </div>
                  </button>
                ))}
                {/* Divider + Logout */}
